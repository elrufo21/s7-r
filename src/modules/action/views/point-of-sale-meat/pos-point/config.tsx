...
import { FrmTitle } from '@/modules/action/views/point-of-sale/pos-point/configView'
...
const PosPaymentConfig: FormConfig = {
  ...
  module_url: '/action/209',
  item_url: '/action/209/detail',
  new_url: '/action/209/detail/new',
