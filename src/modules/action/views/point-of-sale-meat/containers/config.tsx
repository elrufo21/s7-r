...
import { FrmMiddle } from '@/modules/action/views/point-of-sale/containers/configView'
...
const PosContainers: FormConfig = {
  ...
  module_url: '/action/212',
  item_url: '/action/212/detail',
  new_url: '/action/212/detail/new',
