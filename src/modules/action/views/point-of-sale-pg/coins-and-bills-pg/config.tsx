...
import { FrmMiddle } from '@/modules/action/views/point-of-sale/coins-and-bills/configView'
import { StatusContactEnum } from '@/shared/components/view-types/viewTypes.types'

const PosPaymentConfig: FormConfig = {
  fnc_name: 'fnc_pos_ticket',
  title: 'Monedas/billetes',
  dsc: 'Monedas/billetes',
  dsc_view: 'name',
  module: ModulesEnum.POINTS_OF_SALE_PG,
  views: [ViewTypeEnum.LIST],
  view_default: ViewTypeEnum.LIST,
  module_url: '/action/407',
  item_url: '/action/407/detail',
  new_url: '/action/407/detail/new',
  // isFavoriteColumn: false,
  no_content_title: 'No se encontraron monedas/billetes',
  no_content_dsc: 'Registre una moneda/billete para agilizar el proceso de cierre de sesión.',
  ribbonList: {
    field: 'state',
    ribbonList: [
      {
