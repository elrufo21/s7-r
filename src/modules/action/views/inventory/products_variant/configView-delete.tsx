...
export function Subtitle({ control, editConfig, watch }: frmElementsProps) {
...
export function FrmTab0({ watch, control, errors, editConfig }: frmElementsProps) {
              ...
              <div className="flex items-center flex-grow">
                ...
                {watch('type') !== TypeProductEnum.COMBO && (
                  <div className="flex items-center flex-shrink-0">
                    <label className="o_form_label mr-2 ">Por</label>
                    <div className="o_field">
                      <AutocompleteControlled
                        name={'uom_id'}
                        placeholder={''}
              ...
              <div className="o_cell">
                <div className="o_field">
                  <SelectControlled
                    ...
                    control={control}
                    errors={errors}
                    options={[{ label: 'Sin codigo de detracción', value: '' }]}
                    editConfig={{ config: editConfig }}
                  />
                </div>
              </div>
              ...
              <div className="o_cell">
                <div className="o_field">
                  <AutocompleteControlled
                    ...
                    errors={errors}
                    options={categories}
                    fnc_loadOptions={loadDataCategories}
                    enlace={true}
                    editConfig={{ config: editConfig }}
                  />
                </div>
