        ...
        <div className="o_form_renderer o_form_editable d-block min-h-screen">
          <div className="o_setting_container ">
            ...
            <div className="settings ">
              ...
              {hash === '#users' ? (
                <div className="app_settings_block " data-key="users">
                  <div id="">
                    <h2>
                      <span>Usuarios</span>
                    </h2>
                    <div className="row mt-4 o_settings_container">
                      <div className="o_setting_right_pane">
                        <label className="o_form_label">Cambiar contraseña</label>
                        <div className="mt8 flex flex-col gap-2">
                          <input
                            type="password"
                            className="form-control mt8"
