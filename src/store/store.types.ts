...
export interface AppSliceState {
  ...
  // Función para limpiar el estado de paginación al cambiar de action
...
export interface UserSliceState {
  ...
  comprobateUser: (email: string, password: string) => Promise<void>
  userLoginInfo: {
    email: string
    password: string
  }
  setUserLoginInfo: (userLoginInfo: { email: string; password: string }) => void
...
export interface PointsOfSaleSliceState {
  ...
  prevItem: any
  setPrevItem: (prevItem: any) => void
  setSelectedLine: (order_id: string, line_id: string | null) => void
  sync_data: boolean
  setSyncData: (sync_data: boolean) => void
  updateOrderPartner: (order_id: string, partner_id: number, partner_name: string) => void
  localMode: boolean
  isWeightMode: boolean
  setIsWeightMode: (isWeightMode: boolean) => void
  PC_multipleSimilarProducts: boolean
  setPC_multipleSimilarProducts: (PC_multipleSimilarProducts: boolean) => void
...
export interface TemporaryValuePg {
  position_pg: number
  payment_state: 'PF' | 'PE'
  line_id: string
  base_quantity: number
...
export interface PointsOfSaleSliceStatePg {
  ...
  temporaryListPg: any
  setTemporaryListPg: (temporaryListPg: any) => void
