    ...
    () => [
      {
        ...
        header: ({ table }) => {
          ...
          return (
            <div className="w-full flex px-[1px] ">
              {' '}
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="px-1 flex justify-center w-full h-full">
              {row.getCanExpand() ? (
      ...
      ...(config.isFavoriteColumn
        ? [
            {
              id: 'is_favorite',
              header: () => <div className="w-full flex px-[1px] "></div>,
              enableResizing: false,
            ...
            {header.isPlaceholder ? null : (
              <div className="w-full box-border flex">
                ...
                {header.column.id !== 'select' &&
                  header.column.id !== 'settings' &&
                  header.column.id !== 'is_favorite' && (
                    <div
                      {...{
...
const StandardRow = ({
  ...
  return (
    ...
    ${row.getIsSelected() ? 'bg-[#d1ecf1] border-b-[#7c828d8f] ' : ''}
